...
Route::middleware('auth')->group(function () {
  ...
  Route::middleware('role:admin,owner')->group(function () {
    ...
    Route::post('stock-batches/import', [StockBatchController::class, 'import'])->name('stock-batches.import');
  ...
  Route::middleware('role:admin,owner')->prefix('reports')->name('reports.')->group(function () {
    ...
    Route::get('/adjustments', [StockAdjustmentController::class, 'report'])->name('adjustments');
  });
